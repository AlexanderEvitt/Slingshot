...
func line(pos: Array, color := Color.WHITE_SMOKE, visible_distance := 0.0) -> MeshInstance3D:
...
func draw(parent: Node, mesh_instance: MeshInstance3D) -> void:
	parent.add_child(mesh_instance)

func undraw(mesh_instance: MeshInstance3D) -> void:
