...
func _process(_delta: float) -> void:
	...
	var caution: bool = ShipData.player_ship.avionics["caution"]
	var warning: bool = ShipData.player_ship.avionics["warning"]
	if caution:
